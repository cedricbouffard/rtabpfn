...
```{r regression-basic, message=FALSE, warning=FALSE}
# Load data
data(mtcars)
...
```{r regression-quantiles, message=FALSE, warning=FALSE}
...
```{r plot-predictions, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
```{r plot-uncertainty, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
```{r plot-conf-int, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
```{r plot-residuals, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
# Calculate residuals
df_resid <- data.frame(
  predicted = preds$.pred,
...
```{r plot-hist-residuals, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
...
```{r plot-feature-rel, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
TabPFN also integrates with tidymodels ecosystem:
