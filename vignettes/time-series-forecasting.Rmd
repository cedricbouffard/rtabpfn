...
# We skip setup_tabpfn() in vignettes to avoid interactive prompts
has_ts <- tryCatch({
...
if (!has_ts) {
  message("Note: tabpfn-time-series not installed. Some examples will be skipped.")
}
...
# Check for tidymodels
has_tidymodels <- requireNamespace("tidymodels", quietly = TRUE)
if (has_tidymodels) {
  library(tidymodels)
}

# Detection of CI environment to avoid heavy computation or hangs
...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  eval = has_ts && has_tidymodels && !is_ci
)
```
