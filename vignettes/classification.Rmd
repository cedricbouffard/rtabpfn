...
```{r classification-basic, eval=TRUE, message=FALSE, warning=FALSE}
# Load data
data(iris)
...
```{r classification-probs, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r evaluation, eval=TRUE, message=FALSE, warning=FALSE}
# Calculate accuracy
...
```{r plot-confusion, eval=TRUE, message=FALSE, warning=FALSE, fig.width=5, fig.height=5}
...
```{r plot-probabilities, eval=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=4}
...
```{r plot-feature-space, eval=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
```{r plot-confidence, eval=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
...
```{r multiclass, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r plot-prob-comparison, eval=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
...
```{r binary-classification, eval=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
