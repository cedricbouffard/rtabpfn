...
- [`check_tabpfn()`](https://cedricbouffard.github.io/rtabpfn/reference/check_tabpfn.md)
  : Check TabPFN Installation
- [`check_gpu_available()`](https://cedricbouffard.github.io/rtabpfn/reference/check_gpu_available.md)
  : Check GPU Availability
- [`check_torch_gpu()`](https://cedricbouffard.github.io/rtabpfn/reference/check_torch_gpu.md)
  : Check PyTorch GPU Status
- [`setup_torch()`](https://cedricbouffard.github.io/rtabpfn/reference/setup_torch.md)
...
- [`get_encoding.tab_pfn()`](https://cedricbouffard.github.io/rtabpfn/reference/tab_pfn.md)
...
- [`set_mode.tab_pfn()`](https://cedricbouffard.github.io/rtabpfn/reference/set_mode.tab_pfn.md)
  : Set mode for TabPFN
